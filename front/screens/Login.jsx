  ...
  const handleSubmitRegister = async () => {
    ...
    if (firstError) {
      ...
      try {
        ...
        setTitleModal("Error");
        setTextModal(
          "Error al intentar registrar nuevo usuario, por favor intentalo mas tarde"
        );
        setIsModalVisible(true);
      }
    }
            ...
            <View className="flex-row">
              <TouchableOpacity
                className={`flex-1 py-4 ${
                  activeTab === "login" ? "bg-red-500" : "bg-gray-200"
                }`}
              ...
              <TouchableOpacity
                className={`flex-1 py-4 ${
                  activeTab === "register" ? "bg-red-500" : "bg-gray-200"
                }`}
                ...
                <>
                  ...
                  >
                    <Text className="text-black/60">
                      {register.birthDate
                        ? register.birthDate.toLocaleDateString("es-ES", {
                            year: "numeric",
                            month: "long",
                            day: "numeric",
                          })
                  ...
                  <View className="flex-row justify-between">
                    ...
                    <View className="bg-gray-100 rounded-full mb-4 w-[48%]">
                      <Picker
                        ...
                        onValueChange={(itemValue) =>
                          handleInputChange("municipality", itemValue)
                        }
                        style={{ color: "gray", height: 52 }}
                      >
                        <Picker.Item
                  ...
                  <View className="flex-row justify-between mb-4">
                    ...
                    <TouchableOpacity
                      className={`flex-1 py-2 px-4 rounded-full ml-2 ${
                        register.bloodTypeRol === "recipient"
                          ? "bg-red-500"
                          : "bg-gray-200"
                      }`}
                      onPress={() =>
                        handleInputChange("bloodTypeRol", "recipient")
                      }
                    >
                      <Text
                        className={`text-center ${
                  ...
                  <View className="bg-gray-100 rounded-full pr-4 mb-4">
                    <Picker
                      ...
                      onValueChange={(itemValue) =>
                        handleInputChange("bloodType", itemValue)
                      }
                      style={{ color: "gray", height: 52 }}
                    >
                      <Picker.Item
                  ...
                  >
                    <Text className="text-black/60">
                      {isImageLoaded ? "Imagen cargada" : "Imagen de perfil"}
                    </Text>
                  ...
                  <View className="flex-row items-center mb-4">
                    <TouchableOpacity
                      className="mr-2"
                      onPress={() => {
                        handleInputChange("termsAgree", !register.termsAgree);
                      }}
                    >
                      {register.termsAgree ? (
                        <FontAwesome5
                    ...
                    <Text className="text-gray-600 h-full">Acepto los</Text>
                    <TouchableOpacity
