...
import { StyleSheet, View, Dimensions, Image, Modal, Text, TouchableOpacity, } from "react-native";
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Hospital Santísima Trinidad",
              direccion:
                "C. Miguel Blanco 1225, Centro, 44100 Guadalajara, Jal.",
              number: "3336148515",
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Vidar Banco de Sangre S. de R.L. de C.V",
              direccion:
                "Av Terranova 556, Prados Providencia, 44670 Guadalajara, Jal.",
              number: "+523318160058",
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Banco de Sangre Jardines de Guadalupe",
              direccion:
                "Av Manuel J. Clouthier 669-interior2do Piso, Jardines de Guadalupe, 45030 Zapopan, Jal.",
              number: "3323428196",
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Corbec Banco de Sangre",
              direccion:
                "Sta. Rita 1031, Chapalita Oriente, 45040 Zapopan, Jal.",
              number: "3318505025",
              redes: "http://corbec.com.mx",
              image:
                "https://images.prismic.io/estudios/4466e0cad6e2606f3fad70d6357b80cd5e51981a_unidad-medica-santa-maria-chapalita.jpg?auto=compress,format",
            })
          }
        >
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "CETS Jalisco",
              direccion:
                "Edificio D, Av Zoquipan No. 1050, Zoquipan, 45170 Zapopan, Jal.",
              number: "3310951562",
              redes: "Cets Jalisco (Facebook)",
              image:
                "https://img.gruporeforma.com/imagenes/960x640/5/470/4469456.jpg",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Convidar Hospital Versalles",
              direccion:
                "Av. Prol. Alcalde 2174, Santa Monica, 44220 Guadalajara, Jal.",
              number: "3338549311",
              redes: "https://www.hospitalversalles.com.mx",
              image:
                "https://www.hospitalversalles.com.mx/wp-content/uploads/2022/06/directorio.png",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Banco de Sangre Hospital Civil Viejo",
              direccion:
                "C. Belén 799-789, Centro Barranquitas, 44280 Guadalajara, Jal.",
              number: "3339424400",
              redes: "https://www.hcg.gob.mx/hcg/",
              image:
                "https://www.gaceta.udg.mx/wp-content/uploads/2020/10/el_hospital_civil_de_guadalajara_fue_el_primero_y_mas_grande_hospital_7.jpg",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              ...
              direccion:
                "Av. Belisario Domínguez 1000, Independencia Oriente, 44340 Guadalajara, Jal.",
              number: "3336172207",
              redes: "http://www.imss.gob.mx/",
              image:
                "https://lh4.googleusercontent.com/-o5kHfdVYUI4/V2h7Mw_NwhI/AAAAAAAAi4U/xT0PPQ3NNhQsbRSan-QsPYIPrJv-u0o-wCJkC/photo.jpg",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Convidar Santa Martha",
              direccion:
                "C. Juan de Dios Robledo 678, Huerta Baeza, 44730 Guadalajara, Jal.",
              number: "3336442865",
              redes: "http://convidar.com.mx",
              image:
                "https://www.tocdoc.com/sites/default/files/consultorios/hospital_santa_martha_guadalajara.png",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "ISSSTE Hospital General 5 de Diciembre",
              direccion:
                "Calz Independencia 940, Centro Cívico, 21000 Mexicali, B.C.",
              number: "6863048048",
              redes: "http://www.issste.gob.mx/",
              image:
                "https://podermx.tv/wp-content/uploads/2018/01/IMG_2327.jpg",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "ISSSTE Hospital General Fray Junipero Serra",
              direccion:
                "Av. las Palmas 4141, 20 de Noviembre, 22100 Tijuana, B.C.",
              number: "6646814386",
              redes: "http://www.issste.gob.mx/",
              image:
                "https://statics.uniradioinforma.com/2022/05/cc3c8abf6094da2a8521f60708e46222.jpg",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Hospital General ISSSTE La Paz",
              direccion:
                "Calle Mar Caribe s/n, El Conchalito, 23090 La Paz, BC",
              number: "6121224888",
              redes: "http://www.issste.gob.mx/",
              image:
                "https://www.palabrabcs.com/wp-content/uploads/2020/01/Issste.jpg",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Clínica Hospital Santa Rosalía",
              direccion:
                "Cuauhtémoc, Adán G. Velarde 98, Magisterial, 23920 Santa Rosalía, B.C.S.",
              number: "6151522418",
              redes: "http://www.issste.gob.mx/",
              image:
                "https://www.palabrabcs.com/wp-content/uploads/2023/09/Issste-Rosalia.jpg",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Clínica Hospital San José del Cabo",
              direccion:
                "Tifon y C. Tifón, C. Retorno Supermanzana del, El Rosarito, 23444 San José del Cabo, B.C.S.",
              number: "6241421600",
              redes: "http://www.issste.gob.mx/",
              image:
                "https://cabovision.tv/images/1012/2023/05/18/1684431766.jpg",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Clínica Hospital Dr. Patricio Trueba Regil",
              direccion:
                "C. 7 30, Miramar, 24030 San Francisco de Campeche, Camp.",
              number: "9811051025",
              redes: "http://www.issste.gob.mx/",
              image:
                "https://www.yo-local.com/sites/default/files/imagen_negocio/Negocio_1813.JPG",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Hospital General Dr. Fracisco Galindo Chávez",
              direccion:
                "Donato Guerra S/N, Segundo de Cobián Centro, 27000 Torreón, Coah.a",
              number: "8712850350",
              redes: "http://www.issste.gob.mx/",
              image:
                "https://tecolotito.elsiglodetorreon.com.mx/i/2024/02/1775472.jpeg",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Clínica Hospital Dr. José María Rodríguez",
              direccion:
                "Francisco Murguía N° 405 esq, Calle Gral. Manuel Pérez Treviño Centro, Zona Centro, 25000 Saltillo, Coah.",
              number: "8444141900",
              redes: "http://www.issste.gob.mx/",
              image:
                "https://i0.wp.com/noticiasnrt.com/wp-content/uploads/2024/02/image-149.png?resize=696%2C464&ssl=1",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Clínica Hospital Monclova",
              direccion:
                "Av. Roble 801, Fraccionamiento La Salle, 25720 Monclova, Coah.",
              number: "8666331826",
              redes: "http://www.issste.gob.mx/",
              image:
                "https://tecolotito.elsiglodetorreon.com.mx/i/2023/09/1725230.jpeg",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Clínica Hospital Nueva Rosita",
              direccion:
                "20 de Noviembre 2402-A, Dávila Moncada, 26870 Nueva Rosita, Coah.",
              number: "8616142287",
              redes: "http://www.issste.gob.mx/",
              image:
                "https://blobcore.periodicolavoz.com.mx/images/2021/04/18/alma40-1-focus-0-0-696-391.png",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Clínica Hospital Piedras Negras",
              direccion:
                "Nava - Piedras Negras, Parque Industrial Piedras Negras, 26070 Piedras Negras, Coah.",
              number: "8781120646",
              redes: "http://www.issste.gob.mx/",
              image:
                "https://superchannel12.com/images/publicaciones/605587/image_09-10-22_13-21-13.webp",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Clínica Hospital Dr. Miguel Angel Trejo Ochoa",
              direccion:
                "Calle Ignacio Sandoval 867, Lomas de Circunvalación, 28010 Colima, Col.",
              number: "3123124460",
              redes: "http://www.issste.gob.mx/",
              image:
                "https://www.afmedios.com/wp-content/uploads/2015/08/af_issstecolima5deagosto2015.jpg",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Clínica Hospital Manzanillo",
              direccion:
                "Av. Parotas, Valle de Las Garzas, I, 28219 Manzanillo, Col.",
              number: "3123142379",
              redes: "http://www.issste.gob.mx/",
              image:
                "https://www.eloccidental.com.mx/local/xvp7uv-unidad-medica-en-manzanillo.jpg/ALTERNATES/LANDSCAPE_768/Unidad%20m%C3%A9dica%20en%20Manzanillo.jpg",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Hospital General Dr. Belisario Domínguez",
              direccion:
                "GTZ, Boulevard Salomón González Blanco #4650, Fracc, Blvrd Lic Salomon Gonzalez Blanco, Las Torres, 29040 Tuxtla Gutiérrez, Chis.",
              number: "9191378578",
              redes: "http://www.issste.gob.mx/",
              image:
                "https://areopago.mx/wp-content/uploads/2022/04/hospital.jpg",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Clínica Hospital Dr. Roberto Nettel Flores",
              direccion:
                "Av. Tuxtepec y Oaxaca s/n, Francisco Villa, 30740 Tapachula de Córdova y Ordóñez, Chis.",
              number: "9626261927",
              redes: "http://www.issste.gob.mx/",
              image:
                "https://contralacorrupcion.mx/wp-content/uploads/2021/06/chiapas-infraestructura-06.jpg",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Clínica Hospital Hidalgo del Parral",
              direccion:
                "FRANCISCO MIRANDA Y, Rep. de Cuba NO. 8, Hidalgo del Parral, Chih.",
              number: "6275228883",
              redes: "http://www.issste.gob.mx/",
              image:
                "https://www.elsoldeparral.com.mx/incoming/w1edez-issste1.jpg/ALTERNATES/LANDSCAPE_400/ISSSTE1.jpg",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
        ...
        <Marker
          ...
          onPress={() =>
            handleMarkerPress({
              title: "Hospital General Dr. Santiago Ramón y Cajal",
              direccion:
                "Predio Canoas s/n, Colonia Obrera, Silvestre Dorador, 34070 Durango, Dgo.",
              number: "6188117513",
              redes: "http://www.issste.gob.mx/",
              image:
                "https://tecolotito.elsiglodedurango.com.mx/i/2023/07/1192818.jpeg",
            })
          }
        >
          {/* Utiliza el ícono de hospital de react-native-vector-icons */}
